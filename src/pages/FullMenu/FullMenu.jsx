...
import cl from "../FullMenu/FullMenu.module.css";
          ...
          <div className={cl.accordion_body}>
            {accordionMenuDBSalad.map((item, index) => (
              <div key={index} className={cl.accordion_item}>
                <div className={cl.accordion_item_left_side}>
                  <div>
                    <img src={item.img} alt="" />
                  </div>
                  <div className={cl.accordion_item_left_side_info}>
                    <h4>{item.name}</h4>
                    <p>Цена: {item.price}</p>
                  </div>
                </div>
                <p className={cl.compound}>{item.compound}</p>
              </div>
            ))}
          </div>
        )}
